    ...
    <div className="flex justify-end">
      <div className="relative inline-block ">
        <button
          ...
          className="relative z-10 flex items-center  text-sm text-gray-600  border border-transparent  focus:ring-opacity-40 dark:focus:ring-opacity-40  dark:text-white focus:outline-none"
        >
          <svg
